...
from api.controllers.cabin_controller import bp as cabin_bp
from api.controllers.activity_registration_controller import bp as activity_registration_bp
from api.controllers.excursion_registration_controller import bp as excursion_registration_bp
...
def create_app():
    ...
    app.register_blueprint(cabin_bp)
