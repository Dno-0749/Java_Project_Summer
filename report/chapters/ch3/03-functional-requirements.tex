...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.72\textwidth,height=0.55\textheight,keepaspectratio]{chapters/ch3/mockup-login.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.86\textwidth,height=0.62\textheight,keepaspectratio]{chapters/ch3/mockup-onboard-account.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.86\textwidth,height=0.62\textheight,keepaspectratio]{chapters/ch3/mockup-operations-dashboard.png}
