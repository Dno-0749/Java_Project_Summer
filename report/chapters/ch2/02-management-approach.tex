...
Do thời hạn dự án chỉ 6 tuần, toàn bộ nội dung đào tạo được dồn nén và triển
khai song song ngay trong 3 ngày đầu của Sprint 1, thay vì trải dài nhiều
tuần như kế hoạch thông thường.
...
\begin{table}[htbp]
    ...
    \begin{tabular}{|p{3.5cm}|p{3cm}|p{2.5cm}|p{2.5cm}|}
        ...
        \hline
        Công nghệ Backend (Java/.NET/NodeJS) & Toàn bộ thành viên & Ngày 1--2 & Bắt buộc \\
        \hline
        Công nghệ Frontend (ReactJS/VueJS) & Toàn bộ thành viên & Ngày 1--2 & Bắt buộc \\
        \hline
        Git, GitHub, quy trình review PR & Toàn bộ thành viên & Ngày 1 & Bắt buộc \\
        \hline
        Thiết kế cơ sở dữ liệu (PostgreSQL/MySQL) & Toàn bộ thành viên & Ngày 2--3 & Bắt buộc \\
        \hline
        Đồng bộ dữ liệu ngoại tuyến (offline-first) & Thành viên phụ trách POS & Ngày 3 & Bắt buộc \\
        \hline
    \end{tabular}
\end{table}